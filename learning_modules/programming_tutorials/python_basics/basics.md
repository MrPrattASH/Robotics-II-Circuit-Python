...
In python, not all variable names are created equal. Good names will make your program much simpler to understand. 

| Good Variable Names | Not So Good Variable Names | Bad Variable Names |
|---------------------|----------------------------|--------------------|
| `user_age`          | `this_is_the_age_of_the_user`                | `1age`             |
| `total_price`       | `pt`               | `@price`           |
| `is_valid`          | `validFlag`                | `is.valid`         |
| `max_speed`         | `fdlksajfldksjaf`             | `max-speed`        |
| `file_path`         | `filelocationpath`             | `filePath$`        |
