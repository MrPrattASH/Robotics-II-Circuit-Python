...
- The first section initializes the onboard LED as an output.
- The second section sets up a list of alarms that will trigger when the button is pressed or after 10 seconds of deep sleep.
...
if isinstance(alarm.wake_alarm, alarm.time.TimeAlarm):
    ...
    #do other things here we want to do if time has elapsed
...
#check if a pin alarm woke us up (no way to know WHAT pin, just that A pin woke us)
    ...
    #do other things here we want to do if a button was pressed. 
