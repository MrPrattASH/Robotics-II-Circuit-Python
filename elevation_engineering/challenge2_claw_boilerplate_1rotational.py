...
lift_arm_servo = servo.ContinuousServo(pwm1)
...
extension_mech_servo = servo.ContinuousServo(pwm2)
...
while True:
    ...
    if ch6 is not None:
        if ch6 == 1:  # switch centered
            intake_servo.throttle = 0  # TODO: Calibrate this speed + direction
        elif ch6 == 0:  # switch down
            intake_servo.throttle = -0.5 # TODO: Calibrate this speed + direction
        elif ch6 == 2:  # switch up
            intake_servo.throttle = 0.5 # TODO: Calibrate this speed + direction
